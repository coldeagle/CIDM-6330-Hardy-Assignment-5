...
class DatabaseManager:
    ...
    def delete(self, table_name, criteria):
        ...
        1. Accepts two arguments: the table name to delete records from, and a dictionary mapping column names to the value to match on.
           The criteria should be a required argument, because you don’t want to delete all your records.
